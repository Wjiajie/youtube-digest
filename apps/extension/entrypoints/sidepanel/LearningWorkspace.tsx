...
export function LearningWorkspace({ learn, understand, record }: { learn: ReactNode; understand: ReactNode; record: ReactNode }) {
  const id = useId();
  ...
  return <div className="learning-workspace">
    ...
    {[learn, understand, record].map((content, index) => <section key={tasks[index]} className="learning-task-panel"
