...
export const config = {
  matcher: [
    ...
    "/((?!api/(?:resources/runs|planning/runs|clarification/turns|translations/runs(?:/[0-9a-fA-F]{8}-(?:[0-9a-fA-F]{4}-){3}[0-9a-fA-F]{12})?|v1/learning-notes|v1/learning-positions)/?$|_next/static|_next/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)",
  ],
};
