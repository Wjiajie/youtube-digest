...
export const config = {
  matcher: [
    ...
    "/((?!api/(?:resources/runs|planning/runs|clarification/turns|v1/learning-notes|v1/learning-positions)/?$|_next/static|_next/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)",
  ],
};
