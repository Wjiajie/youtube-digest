...
it.each(["/api/planning/runs", "/api/clarification/turns", "/api/resources/runs", "/api/v1/learning-notes",
  ...
  "/api/translations/runs/A6000000-0000-4000-8000-000000000001",
  "/api/explanations/runs", "/api/explanations/runs/find", "/api/explanations/runs/A6000000-0000-4000-8000-000000000001",
  "/api/v1/explanations/runs", "/api/v1/explanations/runs/find", "/api/v1/explanations/runs/a6000000-0000-4000-8000-000000000001"])("lets the independently authenticated %s handler own its upload deadline", path => {
...
it.each(["/api/planning/runs/history", "/api/planning/runs-extra", "/api/clarification/turns/history", "/api/clarification/turns-extra",
  ...
  "/api/translations/runs/not-a-uuid",
  "/api/explanations/runs/history", "/api/explanations/runs-extra", "/api/explanations/runs/find/history",
  "/api/explanations/runs/not-a-uuid", "/api/explanations/runs/a6000000-0000-4000-8000-000000000001/history",
  "/api/v1/explanations/runs/history", "/api/v1/explanations/runs-extra", "/api/v1/explanations/runs/find/history",
  "/api/v1/explanations/runs/not-a-uuid", "/api/v1/explanations/runs/a6000000-0000-4000-8000-000000000001/history"])("keeps the upload exception from widening to %s", path => {
