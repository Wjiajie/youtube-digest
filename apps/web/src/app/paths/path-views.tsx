...
export function GoalPathView({ goal, selectedNodeId }: { goal: GoalProgressView; selectedNodeId?: string }) {
  ...
  return <section className="formal-paths" aria-label="正式目标路径">
    ...
    <div className="path-tools"><Link className="bp-button" href="/progress/status">确认节点状态</Link><Link className="bp-button" href="/progress">记录成果</Link><p className="path-muted">进入后选择对应节点，再核对并确认。</p></div>
