...
export default async function ProgressPage() {
  ...
  return <AccountThemeShell accountId={actor.userId} client={client}><main className="shell evidence-shell">
    <nav className="evidence-nav" aria-label="成长档案导航"><Link href="/" className="bp-button">← 返回蓝图</Link><Link href="/progress/status" className="bp-button">确认节点状态</Link><span className="brand">Blueprint / Journal</span></nav>
