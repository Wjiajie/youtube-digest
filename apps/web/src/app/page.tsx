  ...
  return (
    <main className="shell">
      <header className="topbar">
        ...
        <div className="actions"><Link className="bp-button" href="/settings/connections">扩展连接</Link><form action={logoutAction}><button className="bp-button">退出登录</button></form></div>
      </header>
      <div className="hud">
