...
研究基线日期：2026-09-06。2026-09-08 已实际取得一个赛博人物的 glTF、FBX 和包内许可，详见 [真实资产接收台账](asset-intake.md)；尚未导入渲染或完成视觉与性能验收。下文「未下载」描述保留为 9 月 6 日研究时点，不代表最新接收状态。阶段状态仍以 [执行路线](execution-roadmap.md) 为准。
