...
2026-09-10 新增[八影响蒙皮适配与真实 GPU 验证](eight-influence-preview.md)：接收完整源导出，保留原权重，并让顶点、法线、阴影和 CPU 交互一致；仍仅用于内部试装。

四件环境的组合、双主题构图及实际 WebGL 验证在[环境构图试验](environment-study.md)单独记录。本文保留单件人物与 GLB 接收的历史证据，不将其替代完整环境或人物验收。
